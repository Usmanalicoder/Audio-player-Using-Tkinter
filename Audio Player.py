...
root.configure(bg="#0f1a2b")  # Corrected the color code
...
Label(root, image=TOP, bg="#0f1a2b").pack()  # Corrected the color code
...
Button(root,text="Open Folder",width=15,height=2,font=("arial",10,"bold"),fg="white",bg="black",command=open_folder).place(x=330,y=300)

scroll = Scrollbar(music_frame)
playlist=Listbox(music_frame,width=100,font=("arial",10,"bold"),bg="#333333",fg="grey",selectbackground="lightblue",
